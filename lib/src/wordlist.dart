...
enum WordList {
  ...
  List<String> get wordList {
    switch (this) {
      ...
      case WordList.czech:
        return _czech;
      case WordList.portuguese:
        return _portuguese;
    }
  }

  bool validWords(List<String> words) {
...
final List<String> _english = const LineSplitter().convert('''
abandon
ability
able
about
...
final List<String> _japanese = const LineSplitter().convert('''
あいこくしん
あいさつ
あいだ
あおぞら
...
final List<String> _korean = const LineSplitter().convert('''
가격
가끔
가난
가능
...
final List<String> _spanish = const LineSplitter().convert('''
ábaco
abdomen
abeja
abierto
...
final List<String> _french = const LineSplitter().convert('''
abaisser
abandon
abdiquer
abeille
...
final List<String> _italian = const LineSplitter().convert('''
abaco
abbaglio
abbinato
abete
...
final List<String> _czech = const LineSplitter().convert('''
abdikace
abeceda
adresa
agrese
...
final List<String> _portuguese = const LineSplitter().convert('''
abacate
abaixo
abalar
abater
